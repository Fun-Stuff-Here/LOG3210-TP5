...
if (jjtc000) {
  ...
  final public void NumberRegister() throws ParseException {/*@bgen(jjtree) NumberRegister */
  ASTNumberRegister jjtn000 = new ASTNumberRegister(this, JJTNUMBERREGISTER);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
...
if (jjtc000) {
  ...
  final public void Live() throws ParseException {/*@bgen(jjtree) Live */
...
if (jjtc000) {
  ...
  final public void LiveNode() throws ParseException {/*@bgen(jjtree) LiveNode */
...
if (jjtc000) {
  ...
  final public void InNode() throws ParseException {/*@bgen(jjtree) InNode */
...
if (jjtc000) {
  ...
  final public void OutNode() throws ParseException {/*@bgen(jjtree) OutNode */
...
if (jjtc000) {
  ...
  final public void AssignUnaryStmt() throws ParseException {/*@bgen(jjtree) AssignUnaryStmt */
...
if (jjtc000) {
  ...
  final public void AssignDirectStmt() throws ParseException {/*@bgen(jjtree) AssignDirectStmt */
  ...
  private boolean jj_3R_8()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x800,0x800000,0x800000,0x800000,0x4800000,};
	}
